    ...
    <div class="card">
      <Toolbar class="mb-4">
        <template #start>
          ...
          <ButtonArrow label="Delete" icon="pi pi-trash" severity="danger" @click="confirmDeleteSelected"
      ...
      <DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id" scrollable
        scrollHeight="400px" :paginator="true" :rows="10" :filters="filters"
        ...
        <Column :exportable="false" style="min-width:8rem">
          <template #body="slotProps">
            ...
            <ButtonArrow icon="pi pi-trash" outlined rounded severity="danger"
